...
<head>
  ...
  <meta name="theme-color" content="#e4e0db" />

  <!-- Покраска для iOS Safari -->
  <meta name="apple-mobile-web-app-capable" content="yes" />
  <meta name="apple-mobile-web-app-status-bar-style" content="#e4e0db">
    ...
    <div class="container">
      <div class="header__wrapper">
        <div class="header__logo">
          <a href="">
            <img src="img/logo__header.svg" alt="" class="logo logo--header">
          </a>
        </div>
        <!-- /.header__logo -->
        ...
        <div class="header__nav d-none d-md-block">
          <nav class="nav nav--header">
            <ul class="nav__list">
              ...
              <li class="nav__item">
                <a class="nav__link link" href="#team">Специалисты</a>
              </li>
